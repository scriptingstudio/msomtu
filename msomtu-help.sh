...
USE_CASES=(
	...
	"- Удаление кэша шрифтов||Параметр '-cache'."
...
PARAMETERS=(
	...
	"-rev||Ключ. Изменяет результат работы фильтров '-lang' и '-proof' на обратный."
...
[[ -z "$yourlang" ]] && echo "No help for your language? Use parameter '-help en' for english."
