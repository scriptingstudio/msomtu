...
PARAMETERS=(
	...
	"-help||Ключ. Показывает страницу помощи. Язык текста зависит от системных языковых настроек. Есть два вида страницы: краткая и полная. По умолчанию (без параметров) выводится краткая страница. Для полного вида используйте параметр '-help full'. С аргументом 'en' выводится английская страница."
	...
	"-verbose||Ключ. Показывает детальную информацию по объектам выбора в режиме эмуляции. С аргументом 'nl' отменяет вывод списка файлов."
)
EXAMPLES=(
	"ПРИМЕРЫ"
